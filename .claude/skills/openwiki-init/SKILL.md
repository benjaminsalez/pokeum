...
1. `../openwiki/references/structure.md` — structure, **page frontmatter contract**, quality rules, writing goals, AGENTS.md/CLAUDE.md convention.
...
7. **Agent files.** Apply the AGENTS.md/CLAUDE.md convention from `structure.md` (top-level files only, exact section format — it teaches consuming agents to use the `map` command).
