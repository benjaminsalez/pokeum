...
1. `references/structure.md` — wiki structure, the page frontmatter contract, quality rules, writing goals, and the AGENTS.md/CLAUDE.md convention.
...
6. Apply the AGENTS.md/CLAUDE.md convention from `references/structure.md`.
...
5. Check the AGENTS.md/CLAUDE.md OpenWiki section; refresh only if missing or semantically stale.
