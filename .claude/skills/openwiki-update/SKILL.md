...
1. `../openwiki/references/structure.md` — structure, page frontmatter contract, quality rules, AGENTS.md/CLAUDE.md convention.
...
5. **Agent files.** Check the OpenWiki section in top-level `AGENTS.md`/`CLAUDE.md`; refresh only if missing or semantically stale (required even on no-op runs, per `structure.md`).
